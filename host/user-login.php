...
{
$ret=mysqli_query($con,"SELECT * FROM users WHERE email='".$_POST['email']."' and password='".$_POST['password']."'");
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100" style="width:100%;height:620px;">
				...
				<div class="login100-more" style="background-image: url('images/l3.jpg');"></div>
			</div>
		</div>
	</div>
